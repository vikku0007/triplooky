...
<div class="wrapper">
    ...
    <form class="form text-left">
      <div class="row">
        <div class="col-md-6 col-xs-12">
          ...
          <input type="text" id="user" class="form-control" placeholder="Enter your first name">
          </div>
          <div class="form-group">        
        <label style="margin-bottom:0px">User Name<span style="color: #ED1B24">*</span></label>
          <input type="text" id="user" class="form-control" placeholder="Enter your user name">
      </div>
      <div class="form-group">
        ...
        <div class="col-md-6 col-xs-12">
          ...
          <input type="text" id="user" class="form-control" placeholder="Enter your last name">
          </div>
          <div class="form-group">        
        <label style="margin-bottom:0px">E-mail<span style="color: #ED1B24">*</span></label>
          <input type="email" id="user" class="form-control" placeholder="Enter your email address">
      </div>
      <div class="form-group">
  ...
  <p class="forgot-foot mt-2">© 2021 TripLooky</p> 
  </div>
  </div>
